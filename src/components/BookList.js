...
const initialBooks = [
  {
    title: "정치11111111111111111란 무엇인가", author: "김정치", publisher: "사회출판사", image: images, description: "정치의 기본 개념", isbn: "978-89-1234-222-1", category: "정치", locations: [
      { name: "임시용", url: "https://example.com/location1" },
      { name: "12312232", url: "https://example.com/location2" },
      { name: "1231223", url: "https://example.com/location2" },
      { name: "12312223", url: "https://example.com/location2" },
      { name: "12312123", url: "https://example.com/location2" },
      { name: "123122323", url: "https://example.com/location2" },
    ]
  },
